const movies = [
    {
        "id": 1,
        "title": "SUPERMAN",
        "image": "./img/action superman.jpg",
        "genre": "action",
        "release date": "2025",
        "synopsis": "The story of Superman journey to reconcile his Kryptonian heritage with his human upbringing as Clark Kent of Smallville, Kansas. He is the embodiment of truth, justice and the American way, guided by human kindness in a world that sees kindness as old-fashioned."
    }, {
        "id": 2,
        "title": "BANG",
        "image": "./img/bangaction.jpg",
        "genre": "action",
        "release date": "2025",
        "synopsis": "Bang (Jack Kesy), one of the most feared hitmen, questions his violent life after a near-death experience. Seeing a future beyond bloodshed, he wants out—but his crime boss wont let go without a fight."


    }, {
        "id": 3,
        "title": "AVATAR: FIRE AND ASH",
        "image": "./img/avataraction.jpg",
        "genre": "action",
        "release date": "2025",
        "synopsis": "Takes audiences back to Pandora in an immersive new adventure with Marine turned Na'vi leader Jake Sully (Worthington), Na'vi warrior Neytiri (Saldaña) and the Sully family."

    }, {
        "id": 4,
        "title": "TRON: ARES",
        "image": "./img/tronaction.jpg",
        "genre": "action",
        "release date": "2025",
        "synopsis": "Said to focus on the emergence of a sentient program that crosses over into the human world that is not ready for contact."
    }, {
        "id": 5,
        "title": "ANACONDA",
        "image": "./img/anacondaaction.jpg",
        "genre": "action",
        "release date": "2025",
        "synopsis": "Doug (Jack Black) and Griff (Paul Rudd) have been best friends since they were kids, and have always dreamed of remaking their all-time favorite movie: the cinematic classic Anaconda. When a midlife crisis pushes them to finally go for it, they head deep into the Amazon to start filming. But things get real when an actual giant anaconda appears, turning their comically chaotic movie set into a deadly situation. The movie they are dying to make? It might just get them killed"

    }, {
        "id": 6,
        "title": "TOY STORY 5",
        "image": "./img/toystory5comedy.jpg",
        "genre": "comedy",
        "release date": "2025",
        ...
        "id": 7,
        "title": "GHOSTBUSTER",
        "image": "./img/ghostbustercomedy.jpg",
        "genre": "comedy",
        "release date": "1984",
        "synopsis": ": After the members of a team of scientists (Harold Ramis, Dan Aykroyd, Bill Murray) lose their cushy positions at a university in New York City, they decide to become ghostbusters to wage a high-tech battle with the supernatural for money. They stumble upon a gateway to another dimension, a doorway that will release evil upon the city. The Ghostbusters must now save New York from complete destruction."

    }, {
        "id": 8,
        "title": "CRAZY RICH ASIANS",
        "image": "./img/crazyrichasiancomedy.jpg",
        "genre": "comedy",
        "release date": "2018",
        ...
        "id": 9,
        "title": "KUNGFU HUSTLE",
        "image": "./img/kungfuhustlecomedy.jpg",
        "genre": "comedy",
        "release date": "2004",
        ...
        "image": "./img/21jumpstreetcomedy.jpg",
        "genre": "comedy",
        "release date": "2012",
        ...
        "id": 12,
        "title": "A QUIET PLACE",
        "image": "./img/aquietplacehorror.jpg",
        "genre": "horror",
        "release date": "2018",
        ...
        "image": "./img/TheCurseofLaLlorona.jpg",
        "genre": "horror",
        "release date": "2019",
        ...
        "image": "./img/traintobusanhorror.jpg",
        "genre": "horror",
        "release date": "2016",
        ...
        "image": "./img/theballadofwallisislandromance.jpg",
        "genre": "romance",
        "release date": "2025",
        ...
        "id": 17,
        "title": "MUSICA",
        "image": "./img/musicaromance.jpg",
        "genre": "romance",
        "release date": "2024",
        "synopsis": "Based on writer, director and star Rudy Mancuso, Música is a coming-of-age love story that follows an aspiring creator with synesthesia, who must come to terms with an uncertain future, while navigating the pressures of love, family and his Brazilian culture in Newark, New Jersey."
    }, {
        "id": 18,
        "title": "THE BEAST",
        "image": "./img/beastromance.jpg",
        "genre": "romance",
        "release date": "2023",
        ...
        "image": "./img/theideaofyouromance.jpg",
        "genre": "romance",
        "release date": "2024",
        ...
        "id": 21,
        "title": "THE ENDLESS",
        "image": "./img/theendlesssci-fi.jpg",
        "genre": "sci-fi",
        "release date": "2017",
        ...
        "image": "./img/alitabattleangel.jpg",
        "genre": "sci-fi",
        "release date": "2019",
        ...
        "image": "./img/readyplayeronesci-fi.jpg",
        "genre": "sci-fi",
        "release date": "2018",
        "synopsis": "Synopsis: In 2045, the creator of a virtual reality universe promises his fortune to the first person to discover a digital Easter egg. Soon, young Wade Watts finds himself in a reality-bending treasure hunt through the mysterious and fantastical world."


    }, {
        "id": 25,
        "title": "SHIN GODZILLA",
        "image": "./img/shingodzillasci-fi.jpg",
        "genre": "sci-fi",
        "release date": "2016",
...
function getMovieByGenre(genre) {
    ...
    result.forEach(movie => {
        container.innerHTML += `
            <div class="col-md-2">
            <a href="/movie-detail.html" class="text-reset text-decoration-none"> 
              <div class="card">
...
function showGenre(genre) {
    ...
    if (genre === "semua") {
        data = Object.values(movies).flat();
    } else {
        data = movies[genre];
    }
    // console.log(data);
